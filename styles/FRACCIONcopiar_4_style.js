...
var style_FRACCIONcopiar_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (feature.get("FRACCIONES_Código - Nombre de Fracción") !== null && resolution > 0 && resolution < 1) {
            labelText = String(feature.get("FRACCIONES_Código - Nombre de Fracción"));
        }
