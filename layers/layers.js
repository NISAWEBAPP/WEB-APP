...
var lyr_FRACCION_0 = new ol.layer.Vector({
        ...
        var lyr_SateliteOffline = new ol.layer.Tile({
    title: 'Satélite OFFLINE (Solo radios de 500m)',
    type: 'base',
    visible: false,
    source: new ol.source.XYZ({
        url: './tiles/{z}/{x}/{y}.jpg',
        maxZoom: 18 // Mantenemos el maxZoom para que el mapa no desaparezca si haces un acercamiento al nivel 19 o 20
    })
});
...
var layersList = [lyr_FRACCION_0,lyr_OpenStreetMap_1,lyr_SateliteOffline,lyr_MAPA_2,lyr_Combinado_3,lyr_FRACCIONcopiar_4,lyr_fraccion_5,lyr_NOMBREFRACCION_6,lyr_MANZANAS_7];
